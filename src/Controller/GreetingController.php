...
namespace Guiziweb\SyliusTokenPlugin\Controller;
...
final class GreetingController extends AbstractController
{
    ...
    {
        return $this->render(
            '@GuiziwebSyliusTokenPlugin/shop/greeting/static.html.twig',
    ...
    {
        return $this->render(
            '@GuiziwebSyliusTokenPlugin/shop/greeting/dynamic.html.twig',
            ['greeting' => $this->getGreeting($name)],
        );
    }
